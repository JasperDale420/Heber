...
def test_watch_entrypoint_stops_service_on_normal_completion(monkeypatch: pytest.MonkeyPatch) -> None:
    class _FakeService:
        last_instance: _FakeService | None = None
...
def test_watch_entrypoint_preserves_run_error_when_stop_fails(monkeypatch: pytest.MonkeyPatch) -> None:
    class _FakeService:
        last_instance: _FakeService | None = None
...
def test_watch_entrypoint_ignores_stop_error_on_normal_completion(monkeypatch: pytest.MonkeyPatch) -> None:
    class _FakeService:
        last_instance: _FakeService | None = None
...
def test_watch_entrypoint_continues_when_signal_registration_fails(
