...
class MarketTideContextPipeline:
    ...
    def run(
        ...
        try:
            ...
            stats["market_sentiment_score"] = {"status": "error", "error": str(exc)}
            stats["market_premium_momentum"] = {"status": "error", "error": str(exc)}
            return stats
        ...
        if market_tide.empty:
            ...
            stats["market_sentiment_score"] = {"status": "no_data", "rows": 0}
            stats["market_premium_momentum"] = {"status": "no_data", "rows": 0}
            return stats
        ...
        if not dry_run:
            output_path = self.reader.write_gold(
                dataset="market_tide_context_features",
                df=merged,
